...
async function loginAndSignUp(signupData, isLogIn) {
  let url =
    "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAqoDBXkEaYGVlxRqUL3QVoVDfW-kFExz0";
  if (isLogIn) {
    url =
      "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAqoDBXkEaYGVlxRqUL3QVoVDfW-kFExz0";
  }
  try {
