...
async function updateUserProfile(details) {
  const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyAqoDBXkEaYGVlxRqUL3QVoVDfW-kFExz0`;
...
async function getUserProfile(idToken) {
  const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyAqoDBXkEaYGVlxRqUL3QVoVDfW-kFExz0`;
...
async function verifyEmail(idToken) {
  const firebaseApiUrl = `https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyAqoDBXkEaYGVlxRqUL3QVoVDfW-kFExz0`;
    ...
    <div className={styles.profile}>
      ...
      <div className={styles['profile-form']}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <NavLink to={`/home/${idToken}`}>
            <button style={{backgroundColor:"red"}} type="button">Close</button>
          </NavLink>
        </form>
      </div>
    </div>
